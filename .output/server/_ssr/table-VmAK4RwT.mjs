...
//#region node_modules/.nitro/vite/services/ssr/assets/table-VmAK4RwT.js
...
var DialogContent = import_react.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogPortal, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogOverlay, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Content, {
	ref,
	className: cn("fixed left-[50%] top-[50%] z-50 grid w-[95vw] max-w-lg sm:w-full translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 rounded-2xl", className),
	...props,
...
//#endregion
export { TableCell as _, AlertDialogDescription as a, TableRow as b, AlertDialogTitle as c, DialogContent as d, DialogFooter as f, TableBody as g, Table as h, AlertDialogContent as i, Button as l, DialogTitle as m, AlertDialogAction as n, AlertDialogFooter as o, DialogHeader as p, AlertDialogCancel as r, AlertDialogHeader as s, AlertDialog as t, Dialog as u, TableHead as v, TableHeader as y };
