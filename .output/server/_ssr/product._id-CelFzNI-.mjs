...
import { O as ArrowRight, a as Star, d as Plus, m as Minus, o as ShoppingCart, x as Heart } from "../_libs/lucide-react.mjs";
import { s as useProduct } from "./useData-DckFcT4d.mjs";
...
import { i as ProductDetailSkeleton } from "./ProductCardSkeleton-Bqt_gi3A.mjs";
import { t as useFavorites } from "./favorites-CfWs_bXY.mjs";
import { t as Route } from "./product._id-DlEBp5HS.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/product._id-CelFzNI-.js
...
function ProductPage() {
	...
	const sizes = (0, import_react.useMemo)(() => product?.product_sizes ?? [], [product]);
	...
	const { original, final: unitPrice, hasDiscount } = product ? getProductDisplayPrice(product, activeSize) : {
		original: 0,
		final: 0,
		hasDiscount: false
	};
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: "grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 md:items-start",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										hasDiscount && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												children: product.discount_type === "percentage" ? `خصم ${product.discount_value}%` : `خصم ${product.discount_value} ج.م`
											})
										}),
										product.tag && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "pointer-events-auto flex items-center gap-1.5 rounded-full bg-white/95 py-1 px-3 shadow-md backdrop-blur-sm",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: "h-4 w-4 fill-amber-glow text-amber-glow" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "text-xs font-semibold text-ink",
												children: product.tag
											})]
										}),
										product.spicy && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "pointer-events-auto flex items-center gap-1.5 rounded-full bg-crimson/95 py-1 px-3 shadow-md backdrop-blur-sm",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "text-xs font-semibold text-white",
												children: "حار 🌶️"
